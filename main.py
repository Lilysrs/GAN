...
def parse_args():
    ...
    parser.add_argument('--channel_size', type=int, default=1, help='The size of input image')
...
if __name__ == '__main__':
    # path = r"C:\Users\lilys\Desktop\roncali\pytorch-generative-model-collections\data\mnist\MNIST\raw"
    main()
